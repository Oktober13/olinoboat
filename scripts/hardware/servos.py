...
sail = None
rudder = None
os.chdir('/home/trevor/groovy_workspace/sandbox/olinoboat/scripts')
...
class Servo: 
	def __init__(self, name, node=0):
		...
		self.servomin = 0
		self.servomax = 180
		self.degmin = 0	#set the bounds of the signal you send to the servo (45 to 135 for the rudder(?) , 0 to 90 for the sail)
		self.degmax = 180
		self.get_offset()
